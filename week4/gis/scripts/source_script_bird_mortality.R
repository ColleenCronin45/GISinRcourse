...
list(
  ...
  nps = 
    sf::st_read('C:/Users/User/Documents/Week1/gis/gis/data/raw/shapefiles/dc_national_parks.geojson'),
  
  # Multipolygon shapefiles for DC city parks:
  
  parks_and_rec = 
    sf::st_read('C:/Users/User/Documents/Week1/gis/gis/data/raw/shapefiles/dc_parks_and_recreation.geojson')) %>% 
...
list(
  ...
  cicadas = 
    read_csv('C:/Users/User/Documents/Week1/gis/gis/data/raw/cicadas_brood_x_2021.csv') %>% 
  ...
  birds = 
    sf::st_read('C:/Users/User/Documents/Week1/gis/gis/data/raw/shapefiles/sick_birds.geojson')) %>% 
...
rasters <-
  list.files(
    'C:/Users/User/Documents/Week1/gis/gis/data/raw/rasters',
    pattern = 'tif',
    full.names = TRUE) %>%
  purrr::map(
    ~ terra::rast(.x) %>% 
