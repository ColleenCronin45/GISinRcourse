...
# we see that the red dots are distances where there is a significant p value for spatial autocorrelation, up to about 6km, so samples are not spatially independent
...
fitted_canopy_variogram <-
  gstat::fit.variogram(
    canopy_variogram,
    canopy_variogram_starts)

plot(canopy_variogram, 
